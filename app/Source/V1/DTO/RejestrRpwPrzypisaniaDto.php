...
final readonly class RejestrRpwPrzypisaniaDto implements JsonSerializable
{
    /**
     * @param RejestrRpwPrzypisanieWartosciDto[] $values
     * @param array<string, string> $labels
     */
    public function __construct(
        public array $values,
        public array $labels,
        public ?string $sectionLabel = 'Wysyłki RPW',
    ) {
    }
    ...
    public static function defaultLabels(): array
    {
        return [
            ...
            'parent_shipment_uid' => 'UID przesyłki nadrzędnej',
